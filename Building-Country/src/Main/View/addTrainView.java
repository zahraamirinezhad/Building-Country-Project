...
public class addTrainView extends VBox {
    ...
    private Spinner<Integer> WaggonSP;
    private Spinner<Integer> StarsSP;
    ...
    public addTrainView(){
        ...
        WaggonLBL = new Label(" NUMBER OF WAGGONS ");
        StarsLBL = new Label(" NUMBER OF STARS ");
        ServicesLBL = new Label(" SERVICES ");
        ServicesLBL.setAlignment(Pos.CENTER);
        ServicesLBL.setTextFill(Paint.valueOf("#a41998"));

        CapacitySP = new Spinner<>(1,500,1);
        IDSP = new Spinner<>(100,1000,100);
        FactoryNameTF = new TextField();
        FuelTF = new TextField();
        LastSpeedSP = new Spinner<>(50.0,200.0,50.0);
        WaggonSP = new Spinner<>(1,100,1);
        StarsSP = new Spinner<>(1,5,1);
        ...
        VBox firstColm = new VBox(CapacityLBL,IDLBL,FactoryNameLBL,FuelLBL,LastSpeedLBL,WaggonLBL,StarsLBL);
        ...
        WaggonLBL.setMaxWidth(Double.MAX_VALUE);
        StarsLBL.setMaxWidth(Double.MAX_VALUE);
        firstColm.setSpacing(9);

        VBox secColm = new VBox(CapacitySP,IDSP,FactoryNameTF,FuelTF,LastSpeedSP,WaggonSP,StarsSP);
        ...
        WaggonSP.setMaxWidth(Double.MAX_VALUE);
        StarsSP.setMaxWidth(Double.MAX_VALUE);
        ...
        try {
            Image image1 = new Image(new FileInputStream("images//train-3448-72edc8c66df509608c1e13f712a1436e@1x.jpg"));
    ...
    public Label getWaggonLBL() {
        return WaggonLBL;
    }

    public void setWaggonLBL(Label waggonLBL) {
        WaggonLBL = waggonLBL;
    }

    public Label getStarsLBL() {
        return StarsLBL;
    }

    public void setStarsLBL(Label starsLBL) {
        StarsLBL = starsLBL;
    }
    ...
    public Spinner<Integer> getWaggonSP() {
        return WaggonSP;
    }

    public void setWaggonSP(Spinner<Integer> waggonSP) {
        WaggonSP = waggonSP;
    }

    public Spinner<Integer> getStarsSP() {
        return StarsSP;
    }

    public void setStarsSP(Spinner<Integer> starsSP) {
        StarsSP = starsSP;
    }
